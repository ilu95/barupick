      ...
      <div className="max-w-sm mx-auto pt-8">
        ...
        <div className="flex flex-col gap-2.5 mb-5">
          <button
            ...
            className="w-full flex items-center justify-center gap-2.5 py-3.5 rounded-2xl font-semibold text-sm bg-black text-white active:scale-[0.98] transition-all disabled:opacity-60"
          >
          ...
          <button
            ...
            disabled={!!socialLoading}
            className="w-full flex items-center justify-center gap-2.5 py-3.5 rounded-2xl font-semibold text-sm active:scale-[0.98] transition-all disabled:opacity-60"
            style={{ background: '#FEE500', color: '#191919' }}
          >
            {socialLoading === 'kakao' ? <div className="w-4 h-4 border-2 border-black/30 border-t-black rounded-full animate-spin" /> : <svg width="18" height="18" viewBox="0 0 24 24"><path d="M12 3C6.5 3 2 6.58 2 11c0 2.84 1.87 5.33 4.69 6.75-.16.56-.6 2.05-.69 2.37-.11.4.15.39.31.28.13-.08 2.07-1.37 2.91-1.93.9.13 1.83.2 2.78.2 5.5 0 10-3.58 10-8s-4.5-8-10-8z" fill="#191919" /></svg>}
            {t('auth.kakaoLogin')}
          </button>
          <button
            onClick={() => handleSocial('google')}
            disabled={!!socialLoading}
            className="w-full flex items-center justify-center gap-2.5 py-3.5 rounded-2xl font-semibold text-sm border border-warm-400 bg-white text-warm-900 active:scale-[0.98] transition-all disabled:opacity-60"
          >
            {socialLoading === 'google' ? <div className="w-4 h-4 border-2 border-warm-300 border-t-warm-600 rounded-full animate-spin" /> : <svg width="18" height="18" viewBox="0 0 24 24">
